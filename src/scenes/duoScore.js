...
class DuoScore extends Phaser.Scene {
    ...
    create() {
        ...
        let winnerText = this.add.text(this.cameras.main.width / 2, this.cameras.main.height - 150, '', { fontFamily: 'roadstore, Arial', color: '#282828', fontSize: '7rem' }).setScale(scale).setOrigin(0.5, 0).setScrollFactor(0);
